...
def main():
 ...
 (ROOT/"records/deployment.json").parent.mkdir(parents=True,exist_ok=True)
 (ROOT/"records/deployment.json").write_text(json.dumps(out,indent=2))
