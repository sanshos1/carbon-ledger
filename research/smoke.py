...
def send(c,fn,args):
 ...
 c.wait_for_transaction_receipt(transaction_hash=tx,status=TransactionStatus.ACCEPTED,retries=18,interval=10000);info=c.get_transaction(transaction_hash=tx)
